    ...
    useEffect(() => {
        ...
        const verify = async () => {
            try {
                ...
                setStatus('error');
                setMessage(error.message || 'Failed to verify email. The token may have expired.');
            }
        };
                    ...
                    {status === 'error' && (
                        <div className="flex flex-col items-center gap-4 text-center">
                            ...
                            <p className="text-sm text-default-500">
                                Need a new verification link? <Link href="/auth/resend" size="sm">Resend verification email</Link>
                            </p>
                        </div>
                    )}
                </CardBody>
